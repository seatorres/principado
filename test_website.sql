...
-- --------------------------------------------------------
-- Estructura de tabla para la tabla `is_jeans`
--

CREATE TABLE `is_damas` (
  `damas_id` int(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `is_jeans`
--

INSERT INTO `is_damas` (`damas_id`, `title`, `image`) VALUES
...
-- --------------------------------------------------------
-- Estructura de tabla para la tabla `is_camisetas`
--

CREATE TABLE `is_caballeros` (
  `caballeros_id` int(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `is_caballeros` (`caballeros_id`, `title`, `image`) VALUES
(1, 'Lorem ipsum dolor sit amet consectetur adipisicing elit', '9.jpg'),
(2, 'Quae repudiandae fugiat illo cupiditate', '8.jpg'),
(9, 'Voluptas eum incidunt dolores magni itaque autem', '1.jpg');
...
-- --------------------------------------------------------
-- Estructura de tabla para la tabla `is_shorts`
--

CREATE TABLE `is_ninos` (
  `ninos_id` int(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `is_ninos` (`ninos_id`, `title`, `image`) VALUES
(1, 'Lorem ipsum dolor sit amet consectetur adipisicing elit', '9.jpg'),
(2, 'Quae repudiandae fugiat illo cupiditate', '8.jpg'),
(9, 'Voluptas eum incidunt dolores magni itaque autem', '1.jpg');

-- --------------------------------------------------------
-- Estructura de tabla para la tabla `is_vestidos`
--

CREATE TABLE `is_ninas` (
  `ninas_id` int(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `is_ninas` (`ninas_id`, `title`, `image`) VALUES
(1, 'Lorem ipsum dolor sit amet consectetur adipisicing elit', '9.jpg'),
(2, 'Quae repudiandae fugiat illo cupiditate', '8.jpg'),
(9, 'Voluptas eum incidunt dolores magni itaque autem', '1.jpg');
...
-- Estructura de tabla para la tabla `is_faldas`
--

CREATE TABLE `is_accesorios` (
  `accesorios_id` int(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `is_faldas`
--

INSERT INTO `is_accesorios` (`accesorios_id`, `title`, `image`) VALUES
(1, 'Lorem ipsum dolor sit amet consectetur adipisicing elit', '9.jpg'),
(2, 'Quae repudiandae fugiat illo cupiditate', '8.jpg'),
(9, 'Voluptas eum incidunt dolores magni itaque autem', '1.jpg');
-- --------------------------------------------------------
...
CREATE TABLE `is_galeria` (
  `galeria_id` int(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `is_galeria` (`galeria_id`, `title`, `image`) VALUES
(1, 'Lorem ipsum dolor sit amet consectetur adipisicing elit', '9.jpg'),
(2, 'Quae repudiandae fugiat illo cupiditate', '8.jpg'),
(9, 'Voluptas eum incidunt dolores magni itaque autem', '1.jpg');
...
(1, 'admin', '9f21da8821cf03af06ca2ec94188ed7b', 'Facturaci&oacute;n Web');
...
--
-- Indices de la tabla `is_blusas`
--
ALTER TABLE `is_damas`
  ADD PRIMARY KEY (`damas_id`);
--
-- Indices de la tabla `is_camisetas`
--
ALTER TABLE `is_caballeros`
  ADD PRIMARY KEY (`caballeros_id`);
--
-- Indices de la tabla `is_jeans`
--
ALTER TABLE `is_ninos`
  ADD PRIMARY KEY (`ninos_id`);
--
-- Indices de la tabla `is_shorts`
--
ALTER TABLE `is_ninas`
  ADD PRIMARY KEY (`ninas_id`);
--
-- Indices de la tabla `is_vestidos`
--
ALTER TABLE `is_accesorios`
  ADD PRIMARY KEY (`accesorios_id`);
--
-- Indices de la tabla `is_vestidos`
--
ALTER TABLE `is_galeria`
...
--
  -- AUTO_INCREMENT de la tabla `is_blusas`
--
ALTER TABLE `is_damas`
  MODIFY `damas_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
  --
  -- AUTO_INCREMENT de la tabla `is_shorts`
--
ALTER TABLE `is_caballeros`
  MODIFY `caballeros_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
  --
  -- AUTO_INCREMENT de la tabla `is_vestidos`
--
ALTER TABLE `is_ninos`
  MODIFY `ninos_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
  --
  -- AUTO_INCREMENT de la tabla `is_faldas`
--
ALTER TABLE `is_ninas`
  MODIFY `ninas_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
  --
  -- AUTO_INCREMENT de la tabla `is_playeras`
--
ALTER TABLE `is_accesorios`
  MODIFY `accesorios_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
   --
  -- AUTO_INCREMENT de la tabla `is_playeras`
--
ALTER TABLE `is_galeria`
  MODIFY `galeria_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT de la tabla `is_service`
--
ALTER TABLE `is_service`
  MODIFY `service_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
