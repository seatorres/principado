...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            ...
            $number_record = mysqli_query($mysqli, "SELECT * FROM is_ninos")
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_ninos ORDER BY ninos_id DESC LIMIT $begin, $limit")
                                            or die('Se produjo un error en los datos para realizar consultas en la tabla : '.mysqli_error($mysqli));
            ...
            ?>
                <div class="col-sm-4 col-md-4">
                    <br><br>
                    <div class="thumbnail">
                        <a data-toggle="modal" class="open_modal" href="#" data-id="<?php echo $data['ninos_id']; ?>">
