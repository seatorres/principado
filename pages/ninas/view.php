...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            ...
            $number_record = mysqli_query($mysqli, "SELECT * FROM is_ninas")
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_ninas ORDER BY ninas_id DESC LIMIT $begin, $limit")
                                            or die('Se produjo un error en los datos para realizar consultas en la tabla : '.mysqli_error($mysqli));
            ...
            ?>
                <div class="col-sm-4 col-md-4">
                    <br><br>
                    <div class="thumbnail">
                        <a data-toggle="modal" class="open_modal" href="#" data-id="<?php echo $data['ninas_id']; ?>">
