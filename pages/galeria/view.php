...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            ...
            $number_record = mysqli_query($mysqli, "SELECT * FROM is_galeria")
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_galeria ORDER BY galeria_id DESC LIMIT $begin, $limit")
                                            or die('Se produjo un error en los datos para realizar consultas en la tabla : '.mysqli_error($mysqli));
                ...
                <div class="col-sm-4 col-md-4">
                    ...
                    <div class="thumbnail">
                        <a data-toggle="modal" class="open_modal" href="#" data-id="<?php echo $data['galeria_id']; ?>">
                            <img src="img/<?php echo $data['image']; ?>" alt="portafolio">
                        </a>
                        <div class="caption">
