...
<section class="content-header">
  <h1>
    <i class="fa fa-desktop icon-title"></i> Caballeros

    <a class="btn btn-primary btn-social pull-right" href="?module=form_caballeros&form=add">
    ...
    ?>
      ...
      <div class="box box-primary">
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_caballeros ORDER BY caballeros_id DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Editar' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_caballeros&form=edit&id=$data[caballeros_id]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="modules/caballeros/proses.php?act=delete&id=<?php echo $data['caballeros_id'];?>" onclick="return confirm('Estas seguro que quieres eliminar <?php echo $data['title']; ?> ?');">
