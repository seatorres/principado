...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=ninos"> ninos </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/ninos/proses.php?act=insert" method="POST" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                  ...
                  <a href="?module=ninos" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      // funcion de consulta para mostrar los datos de la tabla is_ninos
      $query = mysqli_query($mysqli, "SELECT * FROM is_ninos WHERE ninos_id='$_GET[id]'") 
...
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="?module=home"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=ninos"> Portafolio </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/ninos/proses.php?act=update" method="POST" enctype="multipart/form-data">
            <div class="box-body">
              
              <input type="hidden" name="ninos_id" value="<?php echo $data['ninos_id']; ?>">
