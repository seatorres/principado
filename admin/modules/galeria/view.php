...
<section class="content-header">
  <h1>
    <i class="fa fa-desktop icon-title"></i> Galeria

    <a class="btn btn-primary btn-social pull-right" href="?module=form_galeria&form=add">
      <i class="fa fa-plus"></i> Agregar
    </a>
  </h1>
<a href="../admin/modules/carousel/sliderslist.php">Gestionar Banner</a>
</section>
    ...
    ?>
      ...
      <div class="box box-primary">
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_galeria ORDER BY galeria_id DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='200' class='center'>
                        <img src='../img/$data[image]' height='150'>
                      </td>
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Editar' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_galeria&form=edit&id=$data[galeria_id]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="modules/galeria/proses.php?act=delete&id=<?php echo $data['galeria_id'];?>" onclick="return confirm('Estas seguro que quieres eliminar <?php echo $data['title']; ?> ?');">
